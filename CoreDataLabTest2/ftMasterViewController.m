...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *findButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemSearch  target:self action:@selector(findCourse:)];
    
    
    
    self.navigationItem.rightBarButtonItems =
    [NSArray arrayWithObjects:addButton, findButton, nil];
